    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('org', models.CharField(blank=True, max_length=100, null=True, verbose_name='所属組織')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('description', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='portfolio.descriptionmodel')),
            ],
            options={
